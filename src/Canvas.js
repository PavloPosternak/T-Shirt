...
import { useGLTF, useTexture, CameraControls, AccumulativeShadows, RandomizedLight, Decal, Environment, Center } from '@react-three/drei'
...
['/1.png', '/2.png', '/3.png','/a.png','/b.png','/d.png'].forEach(useTexture.preload)
